...
@NgModule({
  declarations: [AppComponent, PowerComponent, TemperatureTopComponent, UsersRightComponent, DevicesComponent, TvComponent, SkyComponent, BathroomComponent, More1Component, More2Component, AppleTvComponent],
